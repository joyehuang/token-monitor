...
els.themeToggleButton?.addEventListener('click', () => {
  void selectThemePreset(els.themeToggleButton.dataset.targetPreset || (currentThemeIsLight() ? 'joyeDark' : 'joyeLight'));
});
