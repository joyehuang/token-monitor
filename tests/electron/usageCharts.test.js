...
test('selectPreviewSeries maps period to the right points', () => {
  ...
  const week = selectPreviewSeries(PREVIEW, 'week');
  assert.equal(week.points.length, 7);
  assert.deepEqual(week.points.map((p) => p.date), ['2026-06-02', '2026-06-03', '2026-06-04', '2026-06-05', '2026-06-06', '2026-06-07', '2026-06-08']);
