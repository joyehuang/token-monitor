...
| <img src=".github/assets/tools-icon/xai.png" width="28" alt="Grok Build" /> | Grok Build | `$GROK_HOME/sessions/` 或 `~/.grok/sessions/`、`cli-chat-proxy.grok.com/v1/billing` Bearer token（來自 `grok login` 寫入的 `~/.grok/auth.json`） | ✅ | ✅ | — |
...
| <img src=".github/assets/tools-icon/minimax.png" width="28" alt="Minimax" /> | Minimax | Minimax API 金鑰（`$MINIMAX_TOKEN_PLAN_KEY` 或 `$MINIMAX_API_KEY`，用於查詢 Token Plan 額度） | — | ✅ | — |
